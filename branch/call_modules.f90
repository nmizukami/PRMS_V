...
MODULE PRMS_MODULE
     ...
     &  EQULS = '===================================================================='
      ...
      CHARACTER(LEN=24), PARAMETER :: PRMS_VERSION = 'Version 5.0.0 11/21/2017'
...
! Functions
      ...
      EXTERNAL :: call_modules_restart, check_nhru_params, water_balance, basin_summary, nsegment_summary
...
!***********************************************************************
     ...
     &                         Elapsed_time_start(7) + Elapsed_time_start(8)*0.001
        ...
        PRMS_versn = 'call_modules.f90 2017-11-21 10:15:00Z'
...
!***********************************************************************
      ...
      IF ( Ncascdgw==0 .OR. Model==0 ) Cascadegw_flag = 0
